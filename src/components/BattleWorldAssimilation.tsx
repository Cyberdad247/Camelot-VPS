 ...
 * exact-frame scrubbed scene/connector video, a comprehension layer that explains
 * each subsystem, and scene-local action feedback that confirms important controls.
 */
