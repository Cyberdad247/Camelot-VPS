...
export interface CinematicSceneMedia {
  ...
  clip?: string;
  clipMobile?: string;
  /** Exact rendered frame expected at the end of this scene dive. */
  endFrameId: string;
}
...
export interface CinematicConnectorMedia {
  ...
  clip?: string;
  clipMobile?: string;
  /** Must match the actual rendered terminal frame of the source dive. */
  startFrameId: string;
  /** Must match the actual rendered first frame of the destination dive. */
  endFrameId: string;
}
...
export const BATTLE_CINEMATIC_SCENES: readonly CinematicSceneMedia[] = [
  { id: 'overview', poster: WORLD_TREE_POSTER, clip: '/cinematic/battle/00-overview.mp4', clipMobile: '/cinematic/battle/mobile/00-overview.mp4', endFrameId: 'battle-00-end' },
  { id: 'threats', poster: WORLD_TREE_POSTER, clip: '/cinematic/battle/01-threats.mp4', clipMobile: '/cinematic/battle/mobile/01-threats.mp4', endFrameId: 'battle-01-end' },
  { id: 'telemetry', poster: WORLD_TREE_POSTER, clip: '/cinematic/battle/02-telemetry.mp4', clipMobile: '/cinematic/battle/mobile/02-telemetry.mp4', endFrameId: 'battle-02-end' },
  { id: 'defense', poster: WORLD_TREE_POSTER, clip: '/cinematic/battle/03-defense.mp4', clipMobile: '/cinematic/battle/mobile/03-defense.mp4', endFrameId: 'battle-03-end' },
  { id: 'brains', poster: WORLD_TREE_POSTER, clip: '/cinematic/battle/04-brains.mp4', clipMobile: '/cinematic/battle/mobile/04-brains.mp4', endFrameId: 'battle-04-end' },
  { id: 'ouroboros', poster: WORLD_TREE_POSTER, clip: '/cinematic/battle/05-ouroboros.mp4', clipMobile: '/cinematic/battle/mobile/05-ouroboros.mp4', endFrameId: 'battle-05-end' },
  { id: 'vfs', poster: WORLD_TREE_POSTER, clip: '/cinematic/battle/06-vfs.mp4', clipMobile: '/cinematic/battle/mobile/06-vfs.mp4', endFrameId: 'battle-06-end' },
  { id: 'counter', poster: WORLD_TREE_POSTER, clip: '/cinematic/battle/07-counter.mp4', clipMobile: '/cinematic/battle/mobile/07-counter.mp4', endFrameId: 'battle-07-end' },
  { id: 'command', poster: WORLD_TREE_POSTER, clip: '/cinematic/battle/08-command.mp4', clipMobile: '/cinematic/battle/mobile/08-command.mp4', endFrameId: 'battle-08-end' },
] as const;
